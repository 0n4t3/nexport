...
Nexport is a simple export tool that exports posts on the Nostr network in both zip and PDF form. Servers and nodes don't last forever regardless of the protocol, and if posts aren't mirrored to new servers as old ones go down eventually content might be lost. The ability to export your posts as a sort digital diary might be a handy way of archiving your content.
